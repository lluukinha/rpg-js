class GameObject {
  ...
  async doBehaviorEvent(map) {
    // Dont to anything if there is a more important cutscene
    // or I dont have config to do anything anyway.
    ...
    // Create an event instance out of our next level config
